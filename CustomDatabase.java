...
import java.util.*; //Vector, Hashtable, ...etc.
 ...
 public class CustomDatabase {
  ...
  public int update (
    String str_templated_query,
    String[] ary_str_parameters
  ) {
    try {
  ...
  public Vector<Map<String, String>> selectMultiple (
    String str_query
  ) {
    try {
  ...
  //Usage str_some_string = CustomDatabase.escape_string ( str_some_string ); //(call statically)
  public static String escapeString (
    String str_arbitrary_string
  ) {
